...
export const forecastWeeks: ForecastWeek[] = [
  ...
  },
  {
    ...
    isManualOverride: false,
    changeDrivers: [
      { factor: 'Unexpected demand surge', impact: 70, direction: 'increase' },
      { factor: 'Spring campaign ramp-up', impact: 25, direction: 'increase', product: 'Classic Box' },
      { factor: 'Minor churn uptick', impact: 5, direction: 'decrease' },
    ],
    weekPhase: 'non-live',
    weekout: 2,
    forecastRunDay: 'wednesday',
